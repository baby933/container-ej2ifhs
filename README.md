...
> Be patient! In ~3 mins your app is live, at your [app url](https://container-ej2ifhs.containers.anotherwebservice.com/). It even has a free SSL/TLS certificate 🔒 you're welcome!
...
Your app will be automatically re-deployed with the latest code at: https://container-ej2ifhs.containers.anotherwebservice.com/
...
```
git clone git@github.com:baby933/container-ej2ifhs.git
cd container-ej2ifhs
```
...
```
docker attach container-ej2ifhs
```
